...
\includepdf[pages={1},scale=0.95,pagecommand=\subsection{Lösungsskizzen Funktionsbegriff}]{pictures/fktnbasics.pdf}

\includepdf[pages={2-3},scale=1.0]{pictures/fktnbasics.pdf}
