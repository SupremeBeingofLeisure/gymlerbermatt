...
$$f(x)=x^2,\quad\mathbb{D}=\set{-2,-1,0,1,2}$$
...
\draw[color=black] (0pt,-10pt) node[right] {\footnotesize $0$};
\clip(-1.56,-1.34) rectangle (18.4,15);
\draw[line width=1.5pt, smooth,samples=100,domain=0.0:18.400000000000002, firebrick] plot(\x,{0.25*\x+10});
...
\begin{tikzpicture}[xscale=0.1,yscale=0.012]
    ...
    \draw[-{Latex[length=8pt, width=8pt]}] (0,-50) -- (0,600) node[above] {$y$};
