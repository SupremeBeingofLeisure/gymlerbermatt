...
% Titelblatt setzen
\subject{\includegraphics[width=0.618\textwidth]{pictures/isaacvsleibniznotation}}
>>>>>>> Stashed changes
...
=======
\href{https://www.youtube.com/watch?v=J0FCAuTM9pA}{\qrcode{https://www.youtube.com/watch?v=J0FCAuTM9pA}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=BOGpb1yyD-E}{\qrcode{https://www.youtube.com/watch?v=BOGpb1yyD-E}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=VgUkjQVWASM}{\qrcode{https://www.youtube.com/watch?v=VgUkjQVWASM}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=z-42d5dtA_Q}{\qrcode{https://www.youtube.com/watch?v=z-42d5dtA_Q}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=-KFROqbQkuA}{\qrcode{https://www.youtube.com/watch?v=-KFROqbQkuA}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=5RJYwSTO5w8}{\qrcode{https://www.youtube.com/watch?v=5RJYwSTO5w8}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=O722WzomYN4}{\qrcode{https://www.youtube.com/watch?v=O722WzomYN4}}
>>>>>>> Stashed changes
}
...
\begin{tabular}{|c|c|}
\hline
\rule[-3mm]{0pt}{8mm}$f(x)=$ & $f'(x)=$\\ \hline
\rule[-3mm]{0pt}{8mm}$x^4$ & \\ \hline
\rule[-3mm]{0pt}{8mm}$x^3$ & \\ \hline
\rule[-3mm]{0pt}{8mm}$x^2$ & \\ \hline
\rule[-3mm]{0pt}{8mm}$x$ & \\ \hline
\rule[-3mm]{0pt}{8mm}$x^0$ & \\ \hline
\rule[-3mm]{0pt}{8mm}$\frac{1}{x}=x^{-1}$ & \\ \hline
\rule[-3mm]{0pt}{8mm}$\frac{1}{x^2}=x^{-2}$ & \\ \hline
\rule[-3mm]{0pt}{8mm}$\sqrt{x}=x^{\frac{1}{2}}$ & \\ \hline
\rule[-3mm]{0pt}{8mm}$\sqrt[3]{x}=x^{\frac{1}{3}}$ & \\ \hline
\rule[-3mm]{0pt}{8mm}$\sqrt{x^3}=x^{\frac{3}{2}}$ & \\ \hline
>>>>>>> Stashed changes
\end{tabular}
...
=======
\href{https://www.youtube.com/watch?v=Jv0QEd45vqY}{\qrcode{https://www.youtube.com/watch?v=Jv0QEd45vqY}}
>>>>>>> Stashed changes
}
...
\begin{enumerate}
=======
\href{https://www.youtube.com/watch?v=CYY4jeCU_z4}{\qrcode{https://www.youtube.com/watch?v=CYY4jeCU_z4}}
}
die Masse $M$ (in g) von Glukose bei einem Stoffwechselexperiment in Abh\"angigkeit der Zeit $t$ (in h) gilt:
$$M(t)=4.5-0.03t^2.$$
\begin{enumerate}[a)]
...
=======
\href{https://www.youtube.com/watch?v=4nFIPeEDeMQ}{\qrcode{https://www.youtube.com/watch?v=4nFIPeEDeMQ}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=Qsh0g0nuaoo}{\qrcode{https://www.youtube.com/watch?v=Qsh0g0nuaoo}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=ZITSx3cx0L0}{\qrcode{https://www.youtube.com/watch?v=ZITSx3cx0L0}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=KsMlJTZOaLA}{\qrcode{https://www.youtube.com/watch?v=KsMlJTZOaLA}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=ZGOirKbLJUU}{\qrcode{https://www.youtube.com/watch?v=ZGOirKbLJUU}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=2pExH_iwS9I}{\qrcode{https://www.youtube.com/watch?v=2pExH_iwS9I}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=BH7eAN73sYM}{\qrcode{https://www.youtube.com/watch?v=BH7eAN73sYM}}
>>>>>>> Stashed changes
}
...
=======
\begin{uebenv}{weitereuebungenprod}
>>>>>>> Stashed changes
...
=======
\item $f(x)=\sin\left(\frac{1}{x}\right)$
>>>>>>> Stashed changes
...
=======
\href{https://www.youtube.com/watch?v=DEkaI0LpDBM}{\qrcode{https://www.youtube.com/watch?v=DEkaI0LpDBM}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=MkQ55zu9mEM}{\qrcode{https://www.youtube.com/watch?v=MkQ55zu9mEM}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=HczWnwIKa4A}{\qrcode{https://www.youtube.com/watch?v=HczWnwIKa4A}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=soVDopFBghg}{\qrcode{https://www.youtube.com/watch?v=soVDopFBghg}}
>>>>>>> Stashed changes
}
...
\begin{lsg}{tangente}
    Wir sollen die Tangentengleichung im Punkt $(3|?)$ bestimmen und halten zuerst $\mathbb{D}=\mathbb{R}\setminus\{-1\}$ fest. Die Koordinaten des Punktes $P$ sind $f(3)=\frac{1-3}{1+3}=\frac{-2}{4}=-\frac{1}{2}$, also $(3|-\frac{1}{2})$. Die Steigung ist $f'(x)=\left(\frac{1-x}{1+x}\right)=\frac{-(1+x)-(1-x)}{(1+x)^2}=\frac{-2}{(1+x)^2}$. An der Stelle $3$: $f'(3)=-\frac{1}{8}$ und damit als Ansatz für die Tangente $t(x)=-\frac{1}{8}x+q$. Ferner ist ja $f(3)=-\frac{1}{2}$, was wir in $t$ einsetzen, um $q$ zu bestimmen:
>>>>>>> Stashed changes
    \begin{align*}
        t(3) &= -\frac{1}{2}\\
...
\end{lsg}
=======
    Die Tangentengleichung lautet daher $t(x)=-\frac{1}{8}x-\frac{1}{8}$.
    
    Aus $g'(x)=1\stackrel{!}{=}\frac{-2}{(1+x)^2}=f'(x)$ folgt $x^2+2x+3=0$ mit Diskriminante $2^2-4\cdot3<0$. Daher beträgt die Steigung von $f$ an keiner Stelle $0$.
\end{lsg}
...
=======
        \item $\frac{1}{2}a\cos(\varphi)$
        \item $4\cos(4x)$
        \item $\frac{1}{2}(\cos(t))^{-\frac{1}{2}}\cdot(-\sin(t))$
        \item $2\cos(u)(-\sin(u))$
        \item $\cos(\frac{1}{x})(-x^{-2})$
        \item $-\sin(a\sqrt{\varphi})\cdot a\frac{1}{2}\varphi^{-\frac{1}{2}}$
>>>>>>> Stashed changes
...
=======
\href{https://www.youtube.com/watch?v=VloOTGZ8SGQ}{\qrcode{https://www.youtube.com/watch?v=VloOTGZ8SGQ}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=X6RepNNUTLw}{\qrcode{https://www.youtube.com/watch?v=X6RepNNUTLw}}
>>>>>>> Stashed changes
}
\begin{itemize}
...
=======
\href{https://www.youtube.com/watch?v=rfXO1n9Av3I}{\qrcode{https://www.youtube.com/watch?v=rfXO1n9Av3I}}
>>>>>>> Stashed changes
}
Funktion
$$g(x)=\mathrm{e}^{-x^2}$$
...
=======
\href{https://www.youtube.com/watch?v=6kFezQk7R-0}{\qrcode{https://www.youtube.com/watch?v=6kFezQk7R-0}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=mpG6fCreiQQ}{\qrcode{https://www.youtube.com/watch?v=mpG6fCreiQQ}}
>>>>>>> Stashed changes
}
Funktion
...
=======
\href{https://www.youtube.com/watch?v=mMQ1X1s0Pa8}{\qrcode{https://www.youtube.com/watch?v=mMQ1X1s0Pa8}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=0HnulX11-DQ}{\qrcode{https://www.youtube.com/watch?v=0HnulX11-DQ}}
>>>>>>> Stashed changes
}
...
=======
\href{https://www.youtube.com/watch?v=tdSILv7E7t4}{\qrcode{https://www.youtube.com/watch?v=tdSILv7E7t4}}
>>>>>>> Stashed changes
}
